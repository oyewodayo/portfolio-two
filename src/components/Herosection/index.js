  ...
  return (
    <div id='about'>
      <HeroContainer>
        ...
        <SocialContainer>
          <SocialLink><FaLinkedin> </FaLinkedin>&nbsp; LinkedIn</SocialLink>
          <SocialLink><FaFacebook> </FaFacebook>&nbsp; Facebook</SocialLink>
          <SocialLink><FaTwitter> </FaTwitter>&nbsp; Twitter</SocialLink>
          <SocialLink><FaInstagram> </FaInstagram>&nbsp; Instagram</SocialLink>
        </SocialContainer>
      </HeroContainer>
    </div>
  )
